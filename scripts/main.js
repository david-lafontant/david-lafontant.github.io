...
const data = [
  {
    name: "Awesome-Books",
    description:
      "AWESOME BOOKS is web application project that allows users to add/remove books from a list and display them on the screen",
    image:
      "https://repository-images.githubusercontent.com/448865710/d514d8d5-981e-42bf-a69e-0a80eac526d5",
  ...
  },
  {
    ...
    image:
      "https://repository-images.githubusercontent.com/500589881/756e38fd-2fdd-4644-9564-c3a63582b8da",
  ...
  },
  {
    name: "Leaderboard",
    description:
      "Leaderboard is a web application that displays sorted scores. Leaderboard stores participants' scores in an API. The participants’ scores are retrieved, sorted, and displayed each time the refresh button is pressed",
    image:
      "https://repository-images.githubusercontent.com/457031042/2a4e4b7f-6b31-49af-9963-5fa23f5eda4f",
  ...
  },
  {
    ...
    image:
      "https://repository-images.githubusercontent.com/473316113/8b8f3923-a101-4115-8f83-94fe40980d44",
  ...
  },
  {
    ...
    image:
      "https://repository-images.githubusercontent.com/503026039/8910b94e-59e9-41e4-8779-317d4dd83ff5",
  ...
  },
  {
    ...
    image:
      "https://repository-images.githubusercontent.com/444822382/e12a421f-2ee7-4407-b4ec-f0ec4c831db3",
...
>
  <div class="m-4 mt-md-2">
    ...
    <a class="btn btn-primary" href="${element.url}" target="_blank" rel="noopener noreferrer"  >Github repository</a>
    <button class="btn btn-secondary disabled">Live</button>
    </p>
  </div>
</div>`;
...
>
  <div class="m-4 mt-md-2">
    ...
    <p class="d-flex justify-content-around">
    <a class="btn btn-primary" href="${element.url}" target="_blank" rel="noopener noreferrer"  >Github repository</a>
    <a class="btn btn-primary" href="${element.live}" target="_blank" rel="noopener noreferrer"  >Live</a>
    </p>
  </div>
</div>`;
      portfolioItem.innerHTML = content;
